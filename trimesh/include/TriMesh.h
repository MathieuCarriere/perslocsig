...
public:
	...
	::std::vector<Face> across_edge;
        ...
        float totalFaceArea;
	std::vector< std::vector<float> > sdfData;
	std::vector< std::vector<float> > vsiData;
	std::vector< std::vector<float> > dist_faces_across_edge;
	std::vector< std::vector<int> >   edges;
	std::vector< std::vector<int> >   edgesVertices;
	std::vector< std::vector<int> >   verticesToEdges;
